...
def word_wnid_dict():
    ...
    word_to_wnid_dict = {}
    wnid_to_word_dict = {}
    with open('/home/t-yuche/panorama/video-indexing/lib/wordnet_data/synset_words.txt') as f:
        for l in f:
            wnid = l.strip()[:9]
            s = l.strip()[10:]
...
def wnid_to_label_dict():
    ...
    wnidtolabel = {} 
    with open('/home/t-yuche/panorama/video-indexing/lib/wordnet_data/train_caffe.txt') as f:
        for l in f:
            segs = l.strip().split()
...
def word_pref_to_stopword_pref_dict():
    ...
    with open('/home/ubuntu/lib/wordnet_data/new_synset_word.txt') as f:
        data = json.load(f)
        for w in data:
            stop_word = data[w]
...
def word_to_stopword_dict():
    ...
    with open('/home/t-yuche/panorama/video-indexing/lib/wordnet_data/new_synset_word.txt') as f:
        data = json.load(f)
        for w in data:
            stop_word = data[w]
            if type(stop_word) is list:
...
def word_traces_dict():
    ...
    with open('/home/t-yuche/panorama/video-indexing/lib/wordnet_data/synset_word_tree.txt') as f:
